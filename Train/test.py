...
def plot_confusion_matrix(conf_matrix, labels,fname):
    ...
    plt.show()
    plt.savefig("results/folds/fold5_"+fname+"_Conf_mat.png")
    plt.close()
...
if __name__ == '__main__':
    ...
    if fold_num==1:
        ...
        test_directory_path = ['./data/5folds/fold1/']
        ...
        test_directory_path = ['./data/5folds/fold2/']
        ...
        test_directory_path = ['./data/5folds/fold3/']
        ...
        test_directory_path = ['./data/5folds/fold4/']
    ...
    test_dataset = tf.data.Dataset.from_generator(
        lambda: process_each_file(test_directory_path, config),
    ...
    #model = tf.keras.models.load_model('models/new_mod_ada/'+mod_name+'.h5')
    ...
    plot_roc_curve(fpr, tpr, roc_auc, filename='results/folds/fold5_'+fname+'_roc_curve.png')
    ...
    with open(f'results/folds/fold5_{fname}_classification_report.txt', 'w') as f:
        # Write label counts
