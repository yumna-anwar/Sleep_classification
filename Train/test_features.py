...
if __name__ == '__main__':
    ...
    # Load the model
    #mod_name='best_model_features_noppg_win60_batch32_lr0.0001'
    #mod_name='best_model_features_win60_batch32_lr0.0001'
    #mod_name='best_model_features_focalLoss_win60_batch32_lr0.0001'
    mod_name='best_model_features_focalLoss_Robscale_win60_batch32_lr1e-05'
    
    #model = tf.keras.models.load_model('models/new_mod_ada/'+mod_name+'.h5')
    model = tf.keras.models.load_model('models_features/folds/'+mod_name+'.h5')
